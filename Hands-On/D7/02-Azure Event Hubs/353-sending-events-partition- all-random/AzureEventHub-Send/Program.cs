...
namespace AzureEventHub_Send
{
    class Program
    {
        ...
        {
            // Setup1\353 - sending - events - partition - all - random
            ...
            for (int i=1; i<=100000; i++)
            {
                ...
                {
                    new Order() {OrderID=$"P-All-O{i}1",Quantity=10,UnitPrice=9.99m,DiscountCategory="Tier 1" },
                    new Order() {OrderID=$"P-All-O{i}2",Quantity=15,UnitPrice=10.99m,DiscountCategory="Tier 2" },
                    new Order() {OrderID=$"P-All-O{i}3",Quantity=20,UnitPrice=11.99m,DiscountCategory="Tier 3" },
                    new Order() {OrderID=$"P-All-O{i}4",Quantity=25,UnitPrice=12.99m,DiscountCategory="Tier 4" },
                    new Order() {OrderID=$"P-All-O{i}5",Quantity=30,UnitPrice=13.99m,DiscountCategory="Tier 5" }
                };
